"""Smoke tests: env + graders + tasks (no HTTP, no API keys)."""
...
def test_task1_reset_and_step_returns_reward_object(approve_clean):
...
def test_task2_runs_full_episode(approve_clean):
...
def test_task3_requires_steps(approve_clean):
